    ...
    def main():
        ...
        while running:
            ...
            for meteor in meteors:
                ...
                meteor[4] = pygame.Rect((meteor[0] % surface.get_width() - 50), meteor[1], 0, 0).inflate(meteor[6],
                                                                                                        meteor[7])
            ...
            pygame.draw.line(screen, "red", (0, surface.get_height() - 100),
                            (surface.get_width(), surface.get_height() - 100), 5)
            ...
            if keys[pygame.K_DELETE]:
                print("DELETE")
                gameover, score, player_pos, ticksnow, meteors, meteorspawned = f.respawn(gameover, score, player_pos,
                                                                                        ticksnow, meteors, meteorspawned)
                meteors, meteorspawned = m.spawnmeteor(meteors)
